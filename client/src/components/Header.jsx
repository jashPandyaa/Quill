    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            ...
            <img src={assets.star_icon}  className='w-2.5' alt="Ai icon" />
        </div>
        ...
        <p className='my-6 sm:my-8 max-w-2x1 m-auto max-sm:text-xs text-gray-500'>
            This is your space to thing out loud, to share what matters, and to write without filters.
            Whether <br />it's one word or thousand, your story starts right here.
        </p>
