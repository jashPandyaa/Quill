        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 ml-3">Quill</h2>
            </div>
            <p className="text-gray-600 mt-2 max-w-md">
              "Where Words Find Wings" - A platform where stories come alive and ideas take flight.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Legal & Business</h3>
            <ul className="space-y-3">
      ...
      <div className="bg-gray-100 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-24 xl:px-32 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-gray-600 text-sm font-semibold text-2xl">
