...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full ml-6 overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-6 sm:m-4 shadow rounded'>
        ...
        <label htmlFor="image">
          ...
          alt="image in addBlog" className='mt-2 h-16 rounded cursor-pointer'/>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          {loading && ( <div className='absolute right-0 top-0 bottom-0 left-0 flex 
